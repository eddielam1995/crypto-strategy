...
def main():
    ...
    with st.sidebar:
        ...
        # Define config here for buttons to use
        config = {
            'capital': capital, 'fee': 0.001, 'risk_pct': 0.02,
            'rsi_oversold': rsi_oversold, 'rsi_overbought': rsi_overbought,
            'short_rsi_overbought': short_rsi_ob,
            'target_mr': target_mr, 'stop_mr': stop_mr,
            'target_tf': target_tf, 'stop_tf': stop_tf,
